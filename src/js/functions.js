(function () {
	...
	class Bob extends Person {
	    constructor() {
	        ...
	        NotificationCenter$1.default.addObserver("mode", this.setAlgo.bind(this), this.name);

	        NotificationCenter$1.default.addObserver("server", this.notify.bind(this), this.name);
	    }
	}
